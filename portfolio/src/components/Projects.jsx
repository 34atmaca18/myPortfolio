        ...
        <div className='flex flex-col gap-[20px] h-[100%] justify-center'>
          ...
          {projects.map((project,index) => (
              ...
              border-[3px] border-white`}>
                  <img className='w-[250px] h-[250px] max-md:h-[200px] max-md:max-w-[350px] py-3 px-3 rounded-[30px] brightness-50 border-white border-[2px]' src={project.url} alt={project.name} />
                  <div id='yazilar' className='w-[50%] max-md:w-full h-[full] py-3 text-center
                   text-white px-6 flex flex-col justify-center gap-7 max-md:h-fit max-md:py-[40px]'>
